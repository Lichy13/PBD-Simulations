...
float alto_tela = 0.5;
float profundo_tela = 0.5;
int n_ancho_tela = 5;
int n_alto_tela = 5;
int n_profundo_tela = 5;
...
void display(){
  ...
  if(system.ActiveFloor)
    system.floor.drawFloor();
  
  if(system.ActiveSphere)
  {
    pushMatrix();
    translate(system.SpherePosition.x*scale_px,system.SpherePosition.y*-scale_px,system.SpherePosition.z*scale_px);
    sphere(system.SphereRadius*scale_px);
    popMatrix();
  }
